set -l commands "+list-fonts +list-keybinds +list-themes +list-colors +list-actions +edit-config +show-config +validate-config +show-face +crash-report +boo"
...
complete -c ghostty -n "string match -q -- '+*' (commandline -pt)" -f -a "+list-fonts +list-keybinds +list-themes +list-colors +list-actions +edit-config +show-config +validate-config +show-face +crash-report +boo"
